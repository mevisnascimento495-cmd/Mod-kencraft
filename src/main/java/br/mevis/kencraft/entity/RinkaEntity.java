...
public class RinkaEntity extends Monster {
    public RinkaEntity(EntityType<? extends Monster> type, Level level) {
        ...
        this.setItemSlot(EquipmentSlot.CHEST, dyed(Items.LEATHER_CHESTPLATE, DyeColor.RED));
        this.setItemSlot(EquipmentSlot.LEGS, dyed(Items.LEATHER_LEGGINGS, DyeColor.RED));
