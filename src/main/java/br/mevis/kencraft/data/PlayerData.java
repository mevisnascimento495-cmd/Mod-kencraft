...
public record PlayerData(
    ...
    public PlayerData withStatus(String attribute, int value) {
        ...
        return switch (attribute) {
            case "strength" -> copy(value, defense, intelligence, speed, genetics, perception, spiritualDevelopment, life);
            case "defense" -> copy(strength, value, intelligence, speed, genetics, perception, spiritualDevelopment, life);
            case "intelligence" -> copy(strength, defense, value, speed, genetics, perception, spiritualDevelopment, life);
            case "speed" -> copy(strength, defense, intelligence, value, genetics, perception, spiritualDevelopment, life);
            case "genetics" -> copy(strength, defense, intelligence, speed, value, perception, spiritualDevelopment, life);
            case "perception" -> copy(strength, defense, intelligence, speed, genetics, value, spiritualDevelopment, life);
            case "spiritual" -> copy(strength, defense, intelligence, speed, genetics, perception, value, life);
            case "life" -> copy(strength, defense, intelligence, speed, genetics, perception, spiritualDevelopment, value);
            default -> this;
        };
    }
