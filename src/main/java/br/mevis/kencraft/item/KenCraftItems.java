...
public final class KenCraftItems {
    ...
    public static final DeferredHolder<ArmorMaterial,ArmorMaterial> ARF_UNIFORM_MATERIAL=ARMOR_MATERIALS.register("arf_uniform",()->new ArmorMaterial(Util.make(new EnumMap<ArmorItem.Type,Integer>(ArmorItem.Type.class),map->{map.put(ArmorItem.Type.HELMET,0);map.put(ArmorItem.Type.CHESTPLATE,3);map.put(ArmorItem.Type.LEGGINGS,3);map.put(ArmorItem.Type.BOOTS,0);map.put(ArmorItem.Type.BODY,0);}),10,SoundEvents.ARMOR_EQUIP_LEATHER,()->Ingredient.of(Items.WHITE_WOOL),java.util.List.of(new ArmorMaterial.Layer(net.minecraft.resources.ResourceLocation.fromNamespaceAndPath(KenCraft.MOD_ID,"arf_uniform"))),0.0F,0.0F));
