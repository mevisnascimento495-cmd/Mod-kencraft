...
public final class KenCraftItems {
    ...
    public static final DeferredHolder<Item, JinsuikakuItem> JINSUIKAKU = ITEMS.register("jinsuikaku",
            () -> new JinsuikakuItem(new Item.Properties().stacksTo(16).food(
                    new net.minecraft.world.food.FoodProperties.Builder().nutrition(4).saturationModifier(0.4F).alwaysEdible().build())));

    public static final DeferredHolder<Item, JinsuikakuRankCItem> JINSUIKAKU_RANK_C = ITEMS.register("jinsuikaku_rank_c",
            () -> new JinsuikakuRankCItem(new Item.Properties().stacksTo(16).food(
                    new net.minecraft.world.food.FoodProperties.Builder().nutrition(6).saturationModifier(0.6F).alwaysEdible().build())));
